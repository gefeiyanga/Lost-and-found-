...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'http://127.0.0.1:3000/pBasketballList',
      method: 'GET',
      data: {},
      header: { 'content-type': 'application/json' },
      success: function (res) {
  ...
  getbackReq: function () {
    ...
    wx.navigateTo({
      url: `../../pages/getback-req/default?releaseTitle=${this.data.listArr[this.data.index].title}&releaseOpenId=${this.data.listArr[this.data.index].openid}&releaseName=${this.data.listArr[this.data.index].uname}`,
    })
  },
